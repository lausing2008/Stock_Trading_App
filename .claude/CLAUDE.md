...
- **`docs/audits/2026-09-21-utc-date-boundary-triage.md`** — triaged the 16 files docs/incidents/utc-vs-et-date-boundary.md scoped but deferred; fixed 3 risk-limit gates + 13 more real sites, ~90 left as likely-fine [timezone, DST]
