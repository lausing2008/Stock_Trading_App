...
- **`docs/features/congress-insider-data.md`** — Congress Trading Data (Two Independent Implementations); AUD-SMARTMONEY "Who to Follow" tab — 7,691 of 9,453 rows have NO buy/sell direction (all 2,036 Trump), and disclosure lags the trade by a median 40 days: +4.70% from trade date vs +2.89% from disclosure [congress]
