...
- **`docs/incidents/self-tuning-job-performance-bugs.md`** — AUD-MINRR-STYLEBLIND (2026-09-19): same bug as AUD-MINRR-MARKETBLIND, style axis instead of market. Pooled R:R floor learned mostly from GROWTH, silently froze EVERY US SWING portfolio for 16+ days [min_rr_ratio, calibration]
