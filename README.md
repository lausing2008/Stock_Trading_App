...
| **Research Engine** | Full Planning Stage research report — 10 dimensions (technical, fundamental, company, industry, economic, checklist, trading plan, position sizing, AI verdict) — generated by Claude when a stock enters the Planning stage on the Trade Board |
...
│   ├── research-engine/      # Planning Stage Research Intelligence Engine (port 8008)
...
| Research Engine | `/research` | Enter any symbol for an AI research report |
| Research Report | `/research/[symbol]` | Full 9-tab Planning Stage report — technical, fundamental, company, industry, economic, checklist, trading plan, AI verdict |
