...
const NAV_GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'News & Macro',   href: '/intelligence?tab=overview',  color: '#6d28d9', tag: 'new' },
      { label: 'CAPE / Bubble Warning', href: '/intelligence?tab=valuation', color: '#6d28d9', tag: 'new' },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Options Income Guide', href: '/options-income-guide', color: '#a78bfa', tag: 'new' },
