...
const METRICS: Metric[] = [
  ...
  {
    key: 'score', label: 'K-Score', higherBetter: true,
    format: (v) => v != null ? v.toFixed(1) : '—',
  },
  {
    key: 'technical', label: 'Technical', higherBetter: true,
  ...
  {
    key: 'value', label: 'Value', higherBetter: true,
    format: (v) => v != null ? v.toFixed(0) : '—',
  },
  {
    key: 'growth', label: 'Growth', higherBetter: true,
    format: (v) => v != null ? v.toFixed(0) : '—',
  },
  {
    key: 'volatility', label: 'Volatility', higherBetter: true,
    format: (v) => v != null ? v.toFixed(0) : '—',
  },
  {
    key: 'relative_strength', label: 'Rel. Strength', higherBetter: true,
    format: (v) => v != null ? v.toFixed(0) : '—',
  },
  {
