  ...
  useEffect(() => {
    ...
    if (indicators) {
      ...
      for (const [key, style] of Object.entries(smaStyle)) {
        ...
        s.setData(toLine(indicators.ts, vals));
        smaSeries[key] = s;
      }
